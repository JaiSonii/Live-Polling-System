              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    currentPoll ? 'bg-green-100 text-green-800' : 
                    pollResults ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'
                  }`}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    hasAnswered ? 'bg-green-100 text-green-800' : 
                    currentPoll ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-800'
                  }`}>
